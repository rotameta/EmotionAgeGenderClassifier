const classes = ['acunilicali', 'Hadise', 'kaan', 'kemalkilicdaroglu', 'kenanimirzalioglu', 'kivanctatlitug', 'leyla', 'mehmet', 'muharrem', 'muratboz', 'ozgurozel', 'RecepTayyipErdoğan', 'sinan', 'tugay'];
